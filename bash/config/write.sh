...
configWrite() {
  ...
  local APP_ENV
  APP_ENV=$(wex-exec app::app/env -ad="${APP_DIR}")
  ...
  APP_CONFIG_FILE_CONTENT+="\nAPP_NAME=${NAME}"
  APP_CONFIG_FILE_CONTENT+="\nDOCKER_COMPOSE_TTY=${WEX_DOCKER_COMPOSE_TTY}"
  APP_CONFIG_FILE_CONTENT+="\nDOCKER_COMPOSE_STDIN_OPEN=${WEX_DOCKER_COMPOSE_STDIN_OPEN}"
  APP_CONFIG_FILE_CONTENT+="\nDOCKER_COMPOSE_YML_VERSION=${WEX_DOCKER_COMPOSE_YML_VERSION}"
